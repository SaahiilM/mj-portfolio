      ...
      <main>
        ...
        <Section id="about" title="About">
          <p className="max-w-2xl text-base leading-relaxed text-foreground sm:text-lg">
            Detail-oriented MBA candidate with experience supporting reporting,
            documentation, and process-driven initiatives across marketing and
            operations. I focus on analyzing data accurately, managing quality
            checks, and working across stakeholders while maintaining high
